...
<div class="absolute w-full flex justify-around items-center top-52 gap-x-64 invisible md:visible">
  <img class="w-60 xl:w-auto" src="{{ Vite::asset('resources/images/png-assets/taxi-language-learning-1.gif') }}" alt="Taxi Design">
...
<div class="w-full max-w-md bg-gray-300 bg-opacity-80 shadow-lg shadow-gray-700 rounded-xl p-5 space-y-8 mt-28 z-10">
  <div>
    {{-- Toast --}}
    @if(session('error'))
    ...
    @endif
  {{-- End Toast --}}
    <img class="mx-auto h-24 w-auto" src="{{ Vite::asset('resources/images/logo-kampak.png') }}" alt="Your Company">
